...
def loss(self, net_out):
    ...
    # flatten 'em all
    probs = keras.layers.Flatten(_probs)
    proid = keras.layers.Flatten(proid)
    confs = keras.layers.Flatten(confs)
    conid = keras.layers.Flatten(conid)
    coord = keras.layers.Flatten(_coord)
    cooid = keras.layers.Flatten(cooid)
